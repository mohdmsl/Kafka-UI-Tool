...
public class Consumer {
    ...
    public KafkaConsumer<String, String> getConsumerFromStartOffset(String topic) {
        ...
        int numberOfPartitions = new Topic(this.adminClient).getNumberOfPartitions(topic, consumer);
    ...
    public KafkaConsumer<String, String> getConsumerFromStartOffset(String topic, Properties config) {
        KafkaConsumer<String, String> consumer = new KafkaConsumer<>(config);
        int numberOfPartitions = new Topic(this.adminClient).getNumberOfPartitions(topic, consumer);
        List<TopicPartition> list = new ArrayList<>();
        for (int i = 0; i < numberOfPartitions; i++) {
